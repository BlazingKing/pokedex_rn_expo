// attack type → defending type → damage multiplier (Gen 6+)
export const ATTACK_CHART: Record<string, Record<string, number>> = {
...
export const ALL_TYPES = Object.keys(ATTACK_CHART);
